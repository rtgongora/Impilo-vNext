 ...
 * - Media join: the shared Impilo Live room flow —
 ...
 * attendance for this participant) then a scoped room token.
 */
export async function joinLiveClassroom(liveEventId: string): Promise<ClassroomMediaCredentials> {
