-- ============================================================================
-- ndr-service V001 — Initial schema
...
CREATE TABLE ndr_event_outbox (
    ...
    producer            VARCHAR(64)     NOT NULL DEFAULT 'ndr-service',
    ...
    CONSTRAINT uq_ndr_outbox_idempotency UNIQUE (idempotency_key)
);

CREATE INDEX idx_ndr_outbox_unpublished
    ON ndr_event_outbox (created_at)
...
CREATE TABLE idempotency_keys (
    ...
    CONSTRAINT pk_ndr_idempotency_keys PRIMARY KEY (tenant_id, pod_id, idempotency_key)
);
