...
/**
 * Transactional outbox row (table {@code telemonitoring.event_outbox}). Mirrors the
 * canonical Impilo outbox contract so the outbox publisher can relay rows to Kafka via
 * the shared {@link CompanionOutboxPublisher}.
 */
@Entity
@Table(name = "event_outbox", schema = "telemonitoring")
public class EventOutboxEntity {
    ...
    private String producer = "telemonitoring-service";
