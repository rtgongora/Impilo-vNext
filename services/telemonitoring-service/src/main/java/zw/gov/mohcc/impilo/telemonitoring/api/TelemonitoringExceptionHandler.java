package zw.gov.mohcc.impilo.telemonitoring.api;
 ...
 */
@RestControllerAdvice(basePackages = "zw.gov.mohcc.impilo.telemonitoring.api")
public class TelemonitoringExceptionHandler {

    @ExceptionHandler(TelemonitoringDomainException.class)
    public ResponseEntity<Map<String, Object>> domain(TelemonitoringDomainException e) {
