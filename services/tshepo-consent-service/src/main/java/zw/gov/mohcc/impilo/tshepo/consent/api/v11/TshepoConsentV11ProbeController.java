package zw.gov.mohcc.impilo.tshepo.consent.api.v11;
...
/**
 * Minimal v1.1 probe controller for TshepoConsent.
 *
...
public class TshepoConsentV11ProbeController {

    @GetMapping("/health")
    public ResponseEntity<Map<String, Object>> health() {
        var ctx = RequestContextHolder.require();
        Map<String, Object> body = new LinkedHashMap<>();
        body.put("service", "tshepo-consent");
        body.put("status", "UP");
