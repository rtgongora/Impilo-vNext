package zw.gov.mohcc.impilo.shareslip.api.v11;
...
/**
 * Minimal v1.1 probe controller for ShareSlip.
 *
...
public class ShareSlipV11ProbeController {

    @GetMapping("/health")
    public ResponseEntity<Map<String, Object>> health() {
        var ctx = RequestContextHolder.require();
        Map<String, Object> body = new LinkedHashMap<>();
        body.put("service", "share-slip");
        body.put("status", "UP");
