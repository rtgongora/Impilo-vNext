...
public class SecurityBaselineConfig {
    ...
    public AdminAuditEmitter adminAuditEmitter(DataSource dataSource) {
        return new AdminAuditEmitter("product-registry", new AdminAuditOutboxSink(dataSource, "product_registry"));
    }

    @Bean
    public SecretProvider secretProvider() {
        return new EnvSecretProvider("IMPILO_PRODUCT_REGISTRY_");
    }
