package zw.gov.mohcc.impilo.scheduling.config;
...
public class SecurityBaselineConfig {
    ...
    public AdminAuditEmitter adminAuditEmitter(DataSource dataSource) {
        return new AdminAuditEmitter("scheduling", new AdminAuditOutboxSink(dataSource, "scheduling"));
    }

    @Bean
    public SecretProvider secretProvider() {
        return new EnvSecretProvider("IMPILO_SCHEDULING_");
    }
