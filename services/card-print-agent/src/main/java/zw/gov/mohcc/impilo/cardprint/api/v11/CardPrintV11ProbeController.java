package zw.gov.mohcc.impilo.cardprint.api.v11;
...
/**
 * Minimal v1.1 probe controller for CardPrint.
 *
...
public class CardPrintV11ProbeController {

    @GetMapping("/health")
    public ResponseEntity<Map<String, Object>> health() {
        var ctx = RequestContextHolder.require();
        Map<String, Object> body = new LinkedHashMap<>();
        body.put("service", "card-print");
        body.put("status", "UP");
