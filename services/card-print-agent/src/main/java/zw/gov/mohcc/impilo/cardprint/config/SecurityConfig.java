...
/**
 * Card Print Agent security configuration.
 *
 * All REST endpoints require authentication via Envoy ext_authz trust headers.
 * Health/actuator and OpenAPI documentation endpoints are open for probes and dev.
 */
@Configuration
@EnableWebSecurity
