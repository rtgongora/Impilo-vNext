package zw.gov.mohcc.impilo.cardprint.v11;
...
/**
 * Golden Contract integration test for Card Print Agent v1.1 compliance.
 *
...
@ActiveProfiles("test")
public class CardPrintGoldenContractTest extends GoldenContractSuite {
