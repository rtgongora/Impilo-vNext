...
INSERT INTO ns_templates (id, tenant_id, template_key, channel, subject, body, created_at, updated_at)
VALUES
    -- English consent request
    (gen_random_uuid(), 'tenant-moh-zw', 'consent.request.en', 'SMS', 'Impilo Consent',
    ...
    (gen_random_uuid(), 'tenant-moh-zw', 'consent.request.sn', 'SMS', 'Impilo Mvumo',
    ...
    (gen_random_uuid(), 'tenant-moh-zw', 'consent.request.nd', 'SMS', 'Impilo Imvumo',
    ...
    (gen_random_uuid(), 'tenant-moh-zw', 'consent.accepted.en', 'SMS', 'Impilo Consent Accepted',
    ...
    (gen_random_uuid(), 'tenant-moh-zw', 'consent.declined.en', 'SMS', 'Impilo Consent',
    ...
    (gen_random_uuid(), 'tenant-moh-zw', 'account.deletion.confirmed.en', 'SMS', 'Account Deletion',
