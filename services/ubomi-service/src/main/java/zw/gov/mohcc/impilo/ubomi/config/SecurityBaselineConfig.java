...
/**
 * Wave 14 security hardening configuration for UBOMI.
 */
@Configuration
public class SecurityBaselineConfig {
    ...
    public AdminAuditEmitter adminAuditEmitter(DataSource dataSource) {
        return new AdminAuditEmitter("ubomi", new AdminAuditOutboxSink(dataSource, "ubomi"));
    }

    @Bean
    public SecretProvider secretProvider() {
        return new EnvSecretProvider("IMPILO_UBOMI_");
    }
