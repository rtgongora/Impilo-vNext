...
import zw.gov.mohcc.impilo.tuso.core.AppointmentService;
...
/**
 * @deprecated Appointment SoR moved to {@code booking-service} (port 8265).
 *             Experience BFF routes {@code /internal/v1/appointments} to booking-service.
 *             This controller remains as a local fallback shim for direct TUSO callers
 *             and legacy {@code tuso.appointment} rows until migration backfill completes.
 *             See {@code docs/migration/booking-appointment-migration.md}.
 */
@Deprecated(since = "2026-06-07", forRemoval = false)
@RestController
