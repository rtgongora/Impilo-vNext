...
class MarketplaceLauncherProductionSecurityTest {

    @Autowired
    private MockMvc mockMvc;

    @Test
    void launcher_rejectsTrustedHeadersWhenPreviewBypassDisabled() throws Exception {
        mockMvc.perform(get("/internal/v1/marketplace/launcher")
                        ...
                        .header(CompanionHeaders.REQUEST_ID, "req-msika-2")
                        .header(CompanionHeaders.CORRELATION_ID, "corr-msika-2")
