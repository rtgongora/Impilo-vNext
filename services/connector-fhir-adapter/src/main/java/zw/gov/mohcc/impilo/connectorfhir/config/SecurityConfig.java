package zw.gov.mohcc.impilo.connectorfhir.config;
...
/**
 * Connector FHIR Adapter service security configuration.
 *
 ...
 * probe sweep measured the consequence: the FHIR relay and destination-registration endpoints reached application code with no credential.</p>
 *
