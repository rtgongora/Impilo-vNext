package zw.gov.mohcc.impilo.zibo.v11;
...
/**
 * Golden Contract integration test for ZIBO v1.1 compliance.
 *
...
@ActiveProfiles("test")
public class ZiboGoldenContractTest extends GoldenContractSuite {
