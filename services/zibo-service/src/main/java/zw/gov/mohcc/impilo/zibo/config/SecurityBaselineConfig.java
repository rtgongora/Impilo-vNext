...
/**
 * Wave 14 security hardening configuration for ZIBO.
 */
@Configuration
public class SecurityBaselineConfig {
    ...
    public AdminAuditEmitter adminAuditEmitter(DataSource dataSource) {
        return new AdminAuditEmitter("zibo", new AdminAuditOutboxSink(dataSource, "zibo"));
    }

    @Bean
    public SecretProvider secretProvider() {
        return new EnvSecretProvider("IMPILO_ZIBO_");
    }
