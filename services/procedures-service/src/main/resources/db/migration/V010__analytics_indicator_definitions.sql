...
VALUES
(:'tenant', 'PROCEDURE_VOLUME', 'Procedure volume',
...
(:'tenant', 'DELAY_REASON', 'Delay reason',
...
(:'tenant', 'UNPLANNED_ADMISSION', 'Unplanned admission',
...
(:'tenant', 'UNPLANNED_SURGERY', 'Unplanned surgery (return to theatre)',
...
(:'tenant', 'SPECIMEN_ADEQUACY', 'Specimen adequacy',
...
(:'tenant', 'RESULT_TURNAROUND', 'Result turnaround',
...
(:'tenant', 'RESULT_ACKNOWLEDGEMENT', 'Result acknowledgement',
...
(:'tenant', 'SEDATION_SAFETY', 'Sedation safety',
...
(:'tenant', 'DEVICE_OUTCOMES', 'Device outcomes',
...
(:'tenant', 'OPERATOR_AND_SUPERVISION', 'Operator and supervision',
...
(:'tenant', 'STOCKOUT_IMPACT', 'Stockout impact',
