package zw.gov.mohcc.impilo.participation.api;
...
/**
 * Maps domain exceptions to honest HTTP responses with a stable error envelope so the UI can
 * surface real failures rather than hiding them behind empty success states.
 */
@RestControllerAdvice(basePackages = "zw.gov.mohcc.impilo.participation.api")
