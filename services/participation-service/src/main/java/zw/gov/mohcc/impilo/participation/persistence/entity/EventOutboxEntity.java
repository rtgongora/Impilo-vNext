...
/**
 * Transactional outbox row (table {@code participation.event_outbox}). Mirrors the canonical
 * Impilo outbox contract so {@link zw.gov.mohcc.impilo.participation.events.ParticipationOutboxPublisher}
 * can relay rows to Kafka via the shared {@link CompanionOutboxPublisher}.
 */
@Entity
@Table(name = "event_outbox", schema = "participation")
public class EventOutboxEntity {
    ...
    private String producer = "participation-service";
