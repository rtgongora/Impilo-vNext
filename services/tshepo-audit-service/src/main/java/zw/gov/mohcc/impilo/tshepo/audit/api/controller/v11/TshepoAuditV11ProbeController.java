package zw.gov.mohcc.impilo.tshepo.audit.api.controller.v11;
...
/**
 * Minimal v1.1 probe controller for TshepoAudit.
 *
...
public class TshepoAuditV11ProbeController {

    @GetMapping("/health")
    public ResponseEntity<Map<String, Object>> health() {
        var ctx = RequestContextHolder.require();
        Map<String, Object> body = new LinkedHashMap<>();
        body.put("service", "tshepo-audit");
        body.put("status", "UP");
