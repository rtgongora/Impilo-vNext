...
/**
 * Wave 14 security hardening configuration for MUSHEX.
 */
@Configuration
public class SecurityBaselineConfig {
    ...
    public AdminAuditEmitter adminAuditEmitter(DataSource dataSource) {
        return new AdminAuditEmitter("mushex", new AdminAuditOutboxSink(dataSource, "mushex"));
    }

    @Bean
    public SecretProvider secretProvider() {
        return new EnvSecretProvider("IMPILO_MUSHEX_");
    }
