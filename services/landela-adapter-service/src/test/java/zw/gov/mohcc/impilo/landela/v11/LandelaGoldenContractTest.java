package zw.gov.mohcc.impilo.landela.v11;
...
/**
 * Golden Contract integration test for LANDELA v1.1 compliance.
 *
...
@ActiveProfiles("test")
public class LandelaGoldenContractTest extends GoldenContractSuite {
