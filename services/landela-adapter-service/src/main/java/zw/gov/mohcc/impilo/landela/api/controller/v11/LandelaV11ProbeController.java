package zw.gov.mohcc.impilo.landela.api.controller.v11;
...
/**
 * Minimal v1.1 probe controller for Landela.
 *
...
public class LandelaV11ProbeController {

    @GetMapping("/health")
    public ResponseEntity<Map<String, Object>> health() {
        var ctx = RequestContextHolder.require();
        Map<String, Object> body = new LinkedHashMap<>();
        body.put("service", "landela");
        body.put("status", "UP");
