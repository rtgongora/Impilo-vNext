package zw.gov.mohcc.impilo.butano.api.controller.v11;
...
/**
 * Minimal v1.1 probe controller for Butano.
 *
...
public class ButanoV11ProbeController {

    @GetMapping("/health")
    public ResponseEntity<Map<String, Object>> health() {
        var ctx = RequestContextHolder.require();
        Map<String, Object> body = new LinkedHashMap<>();
        body.put("service", "butano");
        body.put("status", "UP");
