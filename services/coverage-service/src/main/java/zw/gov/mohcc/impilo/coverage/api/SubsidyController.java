...
/**
 * Subsidy programmes and the consolidated member enrolment lane (cv_subsidy_enrolments):
 * one enrolment row carries both the annual-cap/value concern (consume drawdowns) and the
 * optional exemption category that downstream costing keys waivers on.
 */
@RestController
...
public class SubsidyController {
    ...
    // ── Member enrolment + annual-cap drawdown + exemption category ─────────
