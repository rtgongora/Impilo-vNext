package zw.gov.mohcc.impilo.msikaflow.api.controller.v11;
...
/**
 * Minimal v1.1 probe controller for MsikaFlow.
 *
...
public class MsikaFlowV11ProbeController {

    @GetMapping("/health")
    public ResponseEntity<Map<String, Object>> health() {
        var ctx = RequestContextHolder.require();
        Map<String, Object> body = new LinkedHashMap<>();
        body.put("service", "msika-flow");
        body.put("status", "UP");
