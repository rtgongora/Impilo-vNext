package zw.gov.mohcc.impilo.msikaflow.v11;
...
/**
 * Golden Contract integration test for MSIKA-FLOW v1.1 compliance.
 *
...
@ActiveProfiles("test")
public class MsikaFlowGoldenContractTest extends GoldenContractSuite {
