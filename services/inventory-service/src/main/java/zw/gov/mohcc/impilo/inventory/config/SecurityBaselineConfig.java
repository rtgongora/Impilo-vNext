...
/**
 * Wave 14 security hardening configuration for INVENTORY.
 */
@Configuration
public class SecurityBaselineConfig {
    ...
    public AdminAuditEmitter adminAuditEmitter(DataSource dataSource) {
        return new AdminAuditEmitter("inventory", new AdminAuditOutboxSink(dataSource, "inventory"));
    }

    @Bean
    public SecretProvider secretProvider() {
        return new EnvSecretProvider("IMPILO_INVENTORY_");
    }
