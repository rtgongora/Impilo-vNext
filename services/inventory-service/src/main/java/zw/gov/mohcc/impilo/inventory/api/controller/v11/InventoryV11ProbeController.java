package zw.gov.mohcc.impilo.inventory.api.controller.v11;
...
/**
 * Minimal v1.1 probe controller for Inventory.
 *
...
public class InventoryV11ProbeController {

    @GetMapping("/health")
    public ResponseEntity<Map<String, Object>> health() {
        var ctx = RequestContextHolder.require();
        Map<String, Object> body = new LinkedHashMap<>();
        body.put("service", "inventory");
        body.put("status", "UP");
