...
/**
 * v1.1 probe controller for surveillance-service — exercises the tech-companion pipeline
...
public class SurvV11ProbeController {

    @GetMapping("/health")
    public ResponseEntity<Map<String, Object>> health() {
        var ctx = RequestContextHolder.require();
        Map<String, Object> body = new LinkedHashMap<>();
        body.put("service", "surveillance-service");
        body.put("status", "UP");
