package zw.gov.mohcc.impilo.oros.v11;
...
/**
 * Golden Contract integration test for OROS v1.1 compliance.
 *
...
@ActiveProfiles("test")
public class OrosGoldenContractTest extends GoldenContractSuite {
