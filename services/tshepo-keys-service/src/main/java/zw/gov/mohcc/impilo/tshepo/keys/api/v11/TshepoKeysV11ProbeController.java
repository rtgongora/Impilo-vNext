package zw.gov.mohcc.impilo.tshepo.keys.api.v11;
...
/**
 * Minimal v1.1 probe controller for TshepoKeys.
 *
...
public class TshepoKeysV11ProbeController {

    @GetMapping("/health")
    public ResponseEntity<Map<String, Object>> health() {
        var ctx = RequestContextHolder.require();
        Map<String, Object> body = new LinkedHashMap<>();
        body.put("service", "tshepo-keys");
        body.put("status", "UP");
