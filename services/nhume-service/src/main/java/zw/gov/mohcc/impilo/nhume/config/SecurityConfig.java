...
/**
 * Nhume service security configuration.
 *
 ...
 * probe sweep measured the consequence: the fleet and courier registration endpoints reached application code with no credential.</p>
 *
