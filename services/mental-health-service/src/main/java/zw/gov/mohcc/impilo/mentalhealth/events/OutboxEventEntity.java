...
/** Transactional outbox row for mental-health domain events. */
@Entity
@Table(name = "mh_event_outbox")
public class OutboxEventEntity {
    ...
    private String producer = "mental-health-service";
    ...
    public static OutboxEventEntity create(
        ...
        e.idempotencyKey = "mental-health-service:"
                + aggregateType + ":"
                + aggregateId + ":"
                + eventType + ":"
