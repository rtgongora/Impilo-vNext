...
public class CostaClient {
    ...
    public CostaClient(RestTemplate restTemplate,
                       @Value("${booking.integrations.costa-base-url}") String baseUrl) {
        this.restTemplate = restTemplate;
        this.baseUrl = IntegrationHttpSupport.trimSlash(baseUrl);
    }

    public Map<String, Object> calculateBill(TrustContext ctx, Map<String, Object> payload) {
        return post(ctx, "/v1/internal/billing/calculate", payload);
    }
    ...
    private Map<String, Object> post(TrustContext ctx, String path, Map<String, Object> payload) {
        try {
            ...
            log.warn("COSTA POST {} failed: {}", path, ex.getMessage());
