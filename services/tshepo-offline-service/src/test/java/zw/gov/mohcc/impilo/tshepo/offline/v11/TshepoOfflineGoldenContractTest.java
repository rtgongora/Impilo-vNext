package zw.gov.mohcc.impilo.tshepo.offline.v11;
...
/**
 * Golden Contract integration test for TSHEPO Offline v1.1 compliance.
 *
...
@ActiveProfiles("test")
public class TshepoOfflineGoldenContractTest extends GoldenContractSuite {
