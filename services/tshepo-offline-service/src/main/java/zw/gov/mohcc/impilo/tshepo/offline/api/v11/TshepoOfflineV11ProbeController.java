package zw.gov.mohcc.impilo.tshepo.offline.api.v11;
...
/**
 * Minimal v1.1 probe controller for TshepoOffline.
 *
...
public class TshepoOfflineV11ProbeController {

    @GetMapping("/health")
    public ResponseEntity<Map<String, Object>> health() {
        var ctx = RequestContextHolder.require();
        Map<String, Object> body = new LinkedHashMap<>();
        body.put("service", "tshepo-offline");
        body.put("status", "UP");
