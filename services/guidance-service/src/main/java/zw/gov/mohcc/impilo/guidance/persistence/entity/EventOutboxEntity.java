...
/**
 * Transactional outbox for guidance-service Kafka publishing via {@link CompanionOutboxPublisher}.
 */
@Entity
@Table(name = "event_outbox", schema = "guidance")
public class EventOutboxEntity {
    ...
    private String producer = "guidance-service";
