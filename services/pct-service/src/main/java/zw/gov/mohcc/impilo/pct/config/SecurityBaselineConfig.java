...
/**
 * Wave 14 security hardening configuration for PCT.
 */
@Configuration
public class SecurityBaselineConfig {
    ...
    public AdminAuditEmitter adminAuditEmitter(DataSource dataSource) {
        return new AdminAuditEmitter("pct", new AdminAuditOutboxSink(dataSource, "pct"));
    }

    @Bean
    public SecretProvider secretProvider() {
        return new EnvSecretProvider("IMPILO_PCT_");
    }
