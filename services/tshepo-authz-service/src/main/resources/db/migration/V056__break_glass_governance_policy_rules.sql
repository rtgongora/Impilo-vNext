-- ============================================================================
-- V056 — BREAK-GLASS emergency-access governance policy rules (CZO-LEAD)
...
-- Authored as V041, renumbered to V056 on merge: 041 was already applied on the
-- estate as fundo-learning policy rules, so the original version would have failed
-- Flyway validation at startup rather than running.
--
