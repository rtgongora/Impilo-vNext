package zw.gov.mohcc.impilo.tshepo.authz.api.v11;
...
/**
 * Minimal v1.1 probe controller for TshepoAuthz.
 *
...
public class TshepoAuthzV11ProbeController {

    @GetMapping("/health")
    public ResponseEntity<Map<String, Object>> health() {
        var ctx = RequestContextHolder.require();
        Map<String, Object> body = new LinkedHashMap<>();
        body.put("service", "tshepo-authz");
        body.put("status", "UP");
