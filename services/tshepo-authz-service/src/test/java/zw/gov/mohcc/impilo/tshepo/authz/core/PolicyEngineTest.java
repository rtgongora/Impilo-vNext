...
class PolicyEngineTest {
    ...
    // ════════════════════════════════════════════════════════════════════
    // V041: break-glass GOVERNANCE surface (management endpoints at the gateway)
    //
    // Mirrors the V041 seed: the /v1/break-glass request/review endpoints are
    ...
    /** The V041 ALLOW rule: raise a break-glass request (verified provider, pinned + min_loa 2). */
    ...
    /** The V041 ALLOW rule: supervisor lists the review queue (pinned to /v1/break-glass/review). */
    ...
    @Test
    @DisplayName("V041: verified PROVIDER (LOA2) POSTing /v1/break-glass -> ALLOW (raise request)")
    ...
    @Test
    @DisplayName("V041: CITIZEN reaching the break-glass surface -> DENY (fail-closed default; never minted)")
    ...
    @Test
    @DisplayName("V041: DISTRICT_SUPERVISOR listing /v1/break-glass/review -> ALLOW (retrospective review)")
    ...
    @Test
    @DisplayName("V041 collision-safety: the review ALLOW does NOT grant another service's /review endpoint")
