package zw.gov.mohcc.impilo.tshepo.authz.v11;
...
/**
 * Golden Contract integration test for TSHEPO Authz v1.1 compliance.
 *
...
@ActiveProfiles("test")
public class TshepoAuthzGoldenContractTest extends GoldenContractSuite {
