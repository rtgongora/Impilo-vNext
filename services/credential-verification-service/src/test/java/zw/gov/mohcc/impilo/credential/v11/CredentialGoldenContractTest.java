package zw.gov.mohcc.impilo.credential.v11;
...
/**
 * Golden Contract integration test for CREDENTIAL-VERIFICATION v1.1 compliance.
 *
...
@ActiveProfiles("test")
public class CredentialGoldenContractTest extends GoldenContractSuite {
