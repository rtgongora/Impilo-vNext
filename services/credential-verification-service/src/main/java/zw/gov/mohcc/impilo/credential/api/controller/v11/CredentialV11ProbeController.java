package zw.gov.mohcc.impilo.credential.api.controller.v11;
...
/**
 * Minimal v1.1 probe controller for Credential.
 *
...
public class CredentialV11ProbeController {

    @GetMapping("/health")
    public ResponseEntity<Map<String, Object>> health() {
        var ctx = RequestContextHolder.require();
        Map<String, Object> body = new LinkedHashMap<>();
        body.put("service", "credential");
        body.put("status", "UP");
