...
public class SecurityBaselineConfig {
    ...
    public AdminAuditEmitter adminAuditEmitter(DataSource dataSource) {
        return new AdminAuditEmitter("credential-verification", new AdminAuditOutboxSink(dataSource, "credential_verification"));
    }

    @Bean
    public SecretProvider secretProvider() {
        return new EnvSecretProvider("IMPILO_CREDENTIAL_VERIFICATION_");
    }
