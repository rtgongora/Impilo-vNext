package zw.gov.mohcc.impilo.referral.config;
...
public class SecurityBaselineConfig {
    ...
    public AdminAuditEmitter adminAuditEmitter(DataSource dataSource) {
        return new AdminAuditEmitter("referral", new AdminAuditOutboxSink(dataSource, "referral"));
    }

    @Bean
    public SecretProvider secretProvider() {
        return new EnvSecretProvider("IMPILO_REFERRAL_");
    }
