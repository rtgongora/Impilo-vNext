...
class MobileResultsControllerTest {

    @Test
    void listResultedOrdersReturnsBadGatewayWhenOrosUnavailable() {
        MobileResultsController controller = new MobileResultsController(new FailingOrosClient());

        var response = controller.listResultedOrders("tenant-1", "req-1", "corr-1", "cpid-1", 0, 20);
