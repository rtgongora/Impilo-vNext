...
/**
 * Pharmacy eLMIS Adapter service security configuration.
 *
 ...
 * exist on this path, and the Phase 0 E probe sweep measured the consequence: dispense synchronisation
