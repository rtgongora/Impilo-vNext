...
/**
 * v1.1 probe controller for security-hardening-service — exercises the tech-companion pipeline
...
public class SecHardenV11ProbeController {
    ...
    public ResponseEntity<Map<String, Object>> testCommand(@RequestBody Map<String, Object> payload) {
        ...
        body.put("service", "security-hardening-service");
