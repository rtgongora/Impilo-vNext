...
public interface ClientIdentifierRepository extends JpaRepository<ClientIdentifierEntity, UUID> {
    ...
    Optional<ClientIdentifierEntity> findByTenantIdAndIdentifierTypeAndIdentifierValue(UUID tenantId, String identifierType, String identifierValue);
    List<ClientIdentifierEntity> findByTenantIdAndClientHealthId(UUID tenantId, UUID clientHealthId);
}
