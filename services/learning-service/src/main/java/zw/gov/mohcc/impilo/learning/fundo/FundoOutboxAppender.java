...
/**
 * Small focused component used by the native Fundo services (Phase 5C/5D)
 * to append v1.1-compliant event-type rows to {@code lrn_event_outbox}.
 *
...
public class FundoOutboxAppender {
    ...
    public void append(String aggregateType, String aggregateId, String v11EventType, Map<String, Object> payload) {
        LearningOutboxEntity e = new LearningOutboxEntity();
        e.setAggregateType(aggregateType);
        e.setAggregateId(aggregateId);
        e.setEventType(v11EventType);
        try {
