package zw.gov.mohcc.impilo.patientsafety.config;
...
/** Wave 14 security baseline (rate limit; v1.1 domain outbox handles audit events). */
@Configuration
public class SecurityBaselineConfig {
    ...
    public SecretProvider secretProvider() {
        return new EnvSecretProvider("IMPILO_PATIENT_SAFETY_");
    }
