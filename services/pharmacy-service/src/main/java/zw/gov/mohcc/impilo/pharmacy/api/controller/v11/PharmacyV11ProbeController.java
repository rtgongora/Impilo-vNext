package zw.gov.mohcc.impilo.pharmacy.api.controller.v11;
...
/**
 * Minimal v1.1 probe controller for Pharmacy.
 *
...
public class PharmacyV11ProbeController {

    @GetMapping("/health")
    public ResponseEntity<Map<String, Object>> health() {
        var ctx = RequestContextHolder.require();
        Map<String, Object> body = new LinkedHashMap<>();
        body.put("service", "pharmacy");
        body.put("status", "UP");
