package zw.gov.mohcc.impilo.offlinesync.config;
...
/**
 * Offline Sync service security configuration.
 *
 ...
 * exist on this path, and the Phase 0 E probe sweep measured the consequence: sync packs
