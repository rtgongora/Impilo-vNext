...
/**
 * v1.1 transactional-outbox envelope (mirrors {@code khuluma_event_outbox} in V001).
 * Every conversation/message/presence/call state change appends one row here; the
 * shared ops-instrumentation relay publishes unpublished rows to Kafka. This is also
 * the durable audit trail for Khuluma domain actions.
 */
@Entity
@Table(name = "khuluma_event_outbox")
public class OutboxEventEntity {
    ...
    private String producer = "khuluma-service";
