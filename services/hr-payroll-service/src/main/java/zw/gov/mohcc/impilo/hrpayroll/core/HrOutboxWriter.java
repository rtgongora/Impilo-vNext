...
@Service
public class HrOutboxWriter {
    private final EventOutboxRepository outboxRepository;
    private final ObjectMapper objectMapper;
    private final EventTopicRegistry registry = new EventTopicRegistry("hrpayroll");

    public HrOutboxWriter(EventOutboxRepository outboxRepository, ObjectMapper objectMapper) {
