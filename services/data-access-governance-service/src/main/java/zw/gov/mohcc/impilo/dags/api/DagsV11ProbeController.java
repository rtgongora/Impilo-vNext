...
/**
 * v1.1 probe controller for data-access-governance-service — exercises the tech-companion pipeline
 * (header enforcement / idempotency / federation authority) without touching
 * business tables the generic contract body cannot satisfy.
 */
@RestController
@RequestMapping("/internal/v1")
public class DagsV11ProbeController {
    ...
    public ResponseEntity<Map<String, Object>> testCommand(@RequestBody Map<String, Object> payload) {
        ...
        body.put("service", "data-access-governance-service");
