package zw.gov.mohcc.impilo.tshepo.identity.v11;
...
/**
 * Golden Contract integration test for TSHEPO Identity v1.1 compliance.
 *
...
@ActiveProfiles("test")
public class TshepoIdentityGoldenContractTest extends GoldenContractSuite {
