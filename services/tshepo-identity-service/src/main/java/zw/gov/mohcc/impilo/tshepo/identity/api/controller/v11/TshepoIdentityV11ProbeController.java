package zw.gov.mohcc.impilo.tshepo.identity.api.controller.v11;
...
/**
 * Minimal v1.1 probe controller for TshepoIdentity.
 *
...
public class TshepoIdentityV11ProbeController {

    @GetMapping("/health")
    public ResponseEntity<Map<String, Object>> health() {
        var ctx = RequestContextHolder.require();
        Map<String, Object> body = new LinkedHashMap<>();
        body.put("service", "tshepo-identity");
        body.put("status", "UP");
