...
/**
 * v1.1 probe controller for OBSERVABILITY.
 *
 * Health (GET /internal/v1/health) is provided by InternalHealthController;
 * this adds the command + federation probes for the tech-companion pipeline:
 *   - POST /internal/v1/test-command    -- idempotency proof
 *   - POST /internal/v1/test-federation -- federation authority proof
 */
@RestController
@RequestMapping("/internal/v1")
public class ObsV11ProbeController {
