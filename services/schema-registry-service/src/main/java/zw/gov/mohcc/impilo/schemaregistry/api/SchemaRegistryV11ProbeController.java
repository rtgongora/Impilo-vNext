...
/**
 * v1.1 probe controller for schema-registry-service — exercises the tech-companion pipeline
...
public class SchemaRegistryV11ProbeController {

    @GetMapping("/health")
    public ResponseEntity<Map<String, Object>> health() {
        var ctx = RequestContextHolder.require();
        Map<String, Object> body = new LinkedHashMap<>();
        body.put("service", "schema-registry-service");
        body.put("status", "UP");
