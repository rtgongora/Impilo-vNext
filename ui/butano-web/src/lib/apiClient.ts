/**
 * BUTANO Web — Trust-Aware API Client
 *
 ...
 * can evaluate every request before it reaches the BUTANO backend.
 *
...
/**
 * Raw fetch for FHIR endpoints that return application/fhir+json
 * directly (not wrapped in ApiEnvelope).
 */
...
export const apiClient = {
  ...
  fhir: <T>(path: string) => fhirRequest<T>("GET", path),
};
