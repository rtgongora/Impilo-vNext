/**
 * OIDC Authorization Code + PKCE flow utilities for vito-web.
 *
 * Flow:
...
const KEYCLOAK_CLIENT_ID =
  process.env.NEXT_PUBLIC_KEYCLOAK_CLIENT_ID || "vito-web";
...
export function parseUserFromToken(accessToken: string): {
  ...
  let actorType: "PROVIDER" | "OPERATOR" | "CITIZEN" | "SYSTEM" = "OPERATOR";
  if (actorTypeClaim) {
    ...
    actorType = "SYSTEM";
  } else if (realmRoles.includes("provider")) {
    actorType = "PROVIDER";
  }
