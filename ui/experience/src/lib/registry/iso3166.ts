...
/** Deployment region drives picker ordering (Zimbabwe-first for national deployments). */
...
/**
 * ISO 3166-1 country list grouped for pickers:
 * 1) Current / deployment country (Zimbabwe for ZW deployments)
 * 2) Common nearby countries (SADC subset)
