...
export const CT_CHEST: Investigation = { code: "CT_CHEST", name: "CT Chest", shortName: "CT Chest", type: "IMAGING", domain: "RESPIRATORY", turnaroundHours: 4, isPanel: false, common: false, resultParameters: [{ code: "CT_CHEST_RPT", name: "Report", unit: "", referenceRange: { unit: "Narrative" } }] };
export const CT_ABDO: Investigation = { code: "CT_ABDO", name: "CT Abdomen", shortName: "CT Abd", type: "IMAGING", domain: "ABDOMINAL", turnaroundHours: 4, isPanel: false, common: false, resultParameters: [{ code: "CT_ABDO_RPT", name: "Report", unit: "", referenceRange: { unit: "Narrative" } }] };
export const MRI_BRAIN: Investigation = { code: "MRI_BRAIN", name: "MRI Brain", shortName: "MRI Brain", type: "IMAGING", domain: "NEUROLOGICAL", turnaroundHours: 8, isPanel: false, common: false, resultParameters: [{ code: "MRI_BRAIN_RPT", name: "Report", unit: "", referenceRange: { unit: "Narrative" } }] };
...
export const US_RENAL: Investigation = { code: "US_RENAL", name: "Renal Ultrasound", shortName: "Renal US", type: "IMAGING", domain: "ABDOMINAL", turnaroundHours: 4, isPanel: false, common: false, resultParameters: [{ code: "US_RENAL_RPT", name: "Report", unit: "", referenceRange: { unit: "Narrative" } }] };
...
export const BIOPSY: Investigation = { code: "BIOPSY", name: "Biopsy (Histology)", shortName: "Biopsy", type: "PATHOLOGY", domain: "HAEMATOLOGY", specimen: "TISSUE", turnaroundHours: 120, isPanel: false, common: false, resultParameters: [{ code: "HISTO_RPT", name: "Histology Report", unit: "", referenceRange: { unit: "Narrative" } }] };
export const FNAC: Investigation = { code: "FNAC", name: "Fine Needle Aspiration Cytology", shortName: "FNAC", type: "PATHOLOGY", domain: "HAEMATOLOGY", specimen: "TISSUE", turnaroundHours: 48, isPanel: false, common: false, resultParameters: [{ code: "CYTO_RPT", name: "Cytology Report", unit: "", referenceRange: { unit: "Narrative" } }] };
