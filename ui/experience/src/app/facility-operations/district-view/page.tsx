...
/**
 * District / national operational snapshot — multi-facility queue pressure (live PCT via BFF).
 * Route: /facility-operations/district-view
 */
      ...
      <AppLayout>
        <PageShell title="District operations" subtitle="Multi-facility queue intelligence">
          <div className="rounded-xl border border-amber-200 bg-amber-50/80 p-6 text-sm text-amber-950">
            ...
            <Link href="/facility-operations" className="mt-3 inline-block text-sm font-semibold text-impilo-700 underline">
  ...
  return (
    <AppLayout>
      <PageShell
        ...
        subtitle="Aggregated queue pressure from PCT queue summaries — no simulated KPIs. Facilities without a valid PCT binding show as UNAVAILABLE."
      >
        <div className="mb-4">
          <Link
        ...
        {loading ? (
          <div className="flex items-center gap-2 py-16 text-sm text-slate-500">
            ...
            Loading facilities and queue snapshots…
          </div>
        ) : merged.length === 0 ? (
