...
/**
 * Facility Operations — operational command hub for the selected facility.
  ...
  return (
    <AppLayout>
      <PageShell
        ...
        subtitle="Queue, scheduling, workforce, beds, patient flow, and alerts — scoped to your selected facility and role."
      >
        {!facility ? (
        ...
        {isAdmin ? (
          <section className="mt-10 border-t border-slate-200 pt-6">
            ...
            <p className="mt-1 text-xs text-slate-500">
              Sovereign registry and asset planes — separate from day-to-day facility command.
            </p>
            <Link
              href="/operations"
