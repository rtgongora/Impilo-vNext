...
/**
 * Emergency / high-risk patient strip — compact identity, allergies, key clinical,
 * resuscitation and consent restrictions. Linked from PatientBanner and summary.
 */
        ...
        <div className="space-y-4 max-w-3xl">
          ...
          <div className="rounded-lg border border-slate-200 p-3 text-xs text-slate-600">
            ...
            <p className="mt-1">
              ...
              next-of-kin. Data comes from the same BFF patient summary and chart APIs.
            </p>
          </div>
