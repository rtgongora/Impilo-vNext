...
function directiveStatusStyle(status: string): { bg: string; icon: ElementType } {
  return STATUS_STYLES[status] ?? { bg: "bg-gray-100 text-gray-600", icon: AlertTriangle };
}
      ...
      <PageShell title="Advance Directives" subtitle="Patient advance care planning and legal directives">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center gap-3 py-16">
            <p className="text-sm text-gray-600">Unable to load advance directives for this patient.</p>
            <button
              type="button"
