...
vi.mock("@tanstack/react-query", () => ({ useQuery: () => ({ data: { data: [{ id: "fm-1", name: "John M.", relationship: "Father", age: 68, deceased: false, deceasedAge: null, causeOfDeath: null, conditions: [{ id: "fc-1", condition: "Type 2 Diabetes Mellitus", onsetAge: 52, status: "Active", notes: "On insulin" }] }, { id: "fm-2", name: "Robert M.", relationship: "Grandfather", age: null, deceased: true, deceasedAge: 72, causeOfDeath: "Myocardial Infarction", conditions: [{ id: "fc-2", condition: "Type 2 Diabetes Mellitus", onsetAge: 48, status: "Deceased", notes: "" }] }] }, isLoading: false }) }));
