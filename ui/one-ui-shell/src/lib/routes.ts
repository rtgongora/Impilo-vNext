...
export const ROUTES: RouteDefinition[] = [
  ...
  // Telemedicine operating-model orientation surfaces: static doctrine shells rendered from
  // checked-in config-as-data (src/lib/telemedicine/*). Live-registry backing is coordinator-gated
  // (HO-2 virtual-hospital substrate, HO-5 clinical groups — see
  // docs/architecture/telemedicine-virtual-hospitals-operating-model.md); until it ships these are
  // allowlisted static shells in scripts/completeness/generate-product-truth.mjs.
