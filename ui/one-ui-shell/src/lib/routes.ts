...
export const ROUTES: RouteDefinition[] = [
  ...
  { path: "/ehr/[patientId]/consultations", zone: "ehr", layout: "ehr", sidebar: "ehr", guard: "facility", pageTitle: "Consultations and MDT", navLabel: "Consultations", navZone: "work" },
  ...
  { path: "/registry/facility-verification", zone: "registry", layout: "app", sidebar: "registry", guard: "role", requiredRole: "REGULATORY_AUTHORITY", pageTitle: "Facility verification", navLabel: "Facility verification", navZone: "professional" },
  ...
  { path: "/finance/insurance-plans", zone: "finance", layout: "app", sidebar: "finance", guard: "role", requiredRole: "FINANCE", pageTitle: "Insurance Plan Terms", navLabel: "Insurance plan terms", navZone: "work" },
  ...
  { path: "/learning/studio", zone: "professional", layout: "app", sidebar: "main", guard: "role", requiredRole: "LEARNING_AUTHOR", pageTitle: "Fundo Studio", navLabel: "Studio", navZone: "professional" },
  { path: "/learning/studio/courses", zone: "professional", layout: "app", sidebar: "main", guard: "role", requiredRole: "LEARNING_AUTHOR", pageTitle: "Studio Courses", navLabel: "Studio Courses" },
  { path: "/learning/studio/courses/new", zone: "professional", layout: "app", sidebar: "main", guard: "role", requiredRole: "LEARNING_AUTHOR", pageTitle: "Studio New Course", navLabel: "Studio New Course" },
  { path: "/learning/studio/courses/[courseId]", zone: "professional", layout: "app", sidebar: "main", guard: "role", requiredRole: "LEARNING_AUTHOR", pageTitle: "Studio Course Detail", navLabel: "Studio Course Detail" },
  { path: "/learning/studio/courses/[courseId]/builder", zone: "professional", layout: "app", sidebar: "main", guard: "role", requiredRole: "LEARNING_AUTHOR", pageTitle: "Studio Course Builder", navLabel: "Course Builder" },
  { path: "/learning/studio/library", zone: "professional", layout: "app", sidebar: "main", guard: "role", requiredRole: "LEARNING_AUTHOR", pageTitle: "Studio Library", navLabel: "Studio Library" },
  { path: "/learning/studio/media", zone: "professional", layout: "app", sidebar: "main", guard: "role", requiredRole: "LEARNING_AUTHOR", pageTitle: "Studio Media", navLabel: "Studio Media" },
  { path: "/learning/studio/media/recordings", zone: "professional", layout: "app", sidebar: "main", guard: "role", requiredRole: "LEARNING_AUTHOR", pageTitle: "Media Recordings", navLabel: "Recordings" },
  { path: "/learning/studio/media/scripts", zone: "professional", layout: "app", sidebar: "main", guard: "role", requiredRole: "LEARNING_AUTHOR", pageTitle: "Media Scripts", navLabel: "Scripts" },
  { path: "/learning/studio/media/voiceovers", zone: "professional", layout: "app", sidebar: "main", guard: "role", requiredRole: "LEARNING_AUTHOR", pageTitle: "Media Voiceovers", navLabel: "Voiceovers" },
  { path: "/learning/studio/media/[mediaId]", zone: "professional", layout: "app", sidebar: "main", guard: "role", requiredRole: "LEARNING_AUTHOR", pageTitle: "Media Asset", navLabel: "Media Asset" },
  { path: "/learning/studio/assessments", zone: "professional", layout: "app", sidebar: "main", guard: "role", requiredRole: "LEARNING_AUTHOR", pageTitle: "Studio Assessments", navLabel: "Studio Assessments" },
  { path: "/learning/studio/surveys", zone: "professional", layout: "app", sidebar: "main", guard: "role", requiredRole: "LEARNING_AUTHOR", pageTitle: "Studio Surveys", navLabel: "Studio Surveys" },
  { path: "/learning/studio/ai", zone: "professional", layout: "app", sidebar: "main", guard: "role", requiredRole: "LEARNING_AUTHOR", pageTitle: "Studio AI", navLabel: "Studio AI" },
  { path: "/learning/studio/publish", zone: "professional", layout: "app", sidebar: "main", guard: "role", requiredRole: "LEARNING_AUTHOR", pageTitle: "Studio Publish", navLabel: "Publish" },
  { path: "/learning/studio/analytics", zone: "professional", layout: "app", sidebar: "main", guard: "role", requiredRole: "LEARNING_AUTHOR", pageTitle: "Studio Analytics", navLabel: "Studio Analytics" },
