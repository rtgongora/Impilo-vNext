...
const RAW_ROLE_GROUPS: Record<string, string[]> = {
  ...
  /** Fundo course authoring — trainers plus admin overrides. TRAINER is a realm role seeded with the persona truth pack. */
  LEARNING_AUTHOR: ["TRAINER", "FACILITY_ADMIN", "SYSTEM_ADMIN", "DEVELOPER"],
