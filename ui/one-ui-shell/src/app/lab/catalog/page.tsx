        ...
        <div className="space-y-6">
          ...
          {catalogQ.isLoading ? (
            ...
            <div className="rounded-lg border border-dashed border-border bg-background p-12 text-center">
              ...
              <h3 className="mt-4 text-sm font-semibold text-foreground">No catalog items</h3>
            ...
            <>
              {categories.length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {categories.map(({ label, description, count }) => (
                    <div
                      key={label}
                      className="rounded-lg border border-border bg-card p-5 hover:border-violet-400 hover:shadow-sm transition-all"
                    >
                      <div className="flex items-center justify-between mb-1">
                        <h3 className="font-semibold text-foreground">{label}</h3>
                        <span className="rounded bg-neutral-100 px-2 py-0.5 text-xs text-muted-foreground">
                          {count} tests
                        </span>
                      </div>
              ...
              {filteredItems.length > 0 ? (
                <div className="rounded-lg border border-border bg-card overflow-hidden">
                  <div className="border-b border-border px-4 py-3 grid grid-cols-4 gap-3 text-xs font-semibold text-muted-foreground uppercase">
                    <span>Code</span>
