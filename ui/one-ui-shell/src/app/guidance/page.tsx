...
const SECTIONS = [
  ...
  { href: "/guidance/education", label: "Health Education", description: "Evidence-based articles, videos, and guides for your conditions", Icon: BookOpen, color: "bg-impilo-50 text-impilo-500" },
