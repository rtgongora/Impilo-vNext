      ...
      <PageShell title="Learning Notifications" subtitle="Comms Hub-aligned notification scheduling for learning reminders and outcomes.">
        <div className="rounded border border-gray-200 bg-white p-4">
          <div className="grid gap-2 md:grid-cols-3">
            ...
            <select value={channelPreference} onChange={(e) => setChannelPreference(e.target.value)} className="rounded border border-gray-300 px-3 py-2 text-sm">
        ...
        <ul className="mt-4 space-y-2">
          {items.map((n) => (
            <li key={n.id} className="rounded border border-gray-200 bg-white px-3 py-2 text-sm">
