        ...
        {!isLoading && !isError && items.length > 0 ? (
          <ul className="grid gap-3 sm:grid-cols-2">
            {items.map((c) => (
              <li
                key={c.id}
                className="rounded-lg border border-border bg-card p-4 transition hover:border-teal-300 hover:shadow-sm"
              >
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-2 flex flex-wrap items-center gap-2 text-xs">
                        {c.category ? (
                          <span className="rounded bg-neutral-100 px-1.5 py-0.5 text-foreground">
                            {c.category}
                          </span>
                        ) : null}
                        {c.level ? (
