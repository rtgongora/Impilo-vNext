 ...
 * when no Provider ID is linked to the signed-in Health ID. Every lane is fully
 * backed by the BFF /api/v1/provider-claim endpoints (claim token, council
 * number, EC match, document upload, invitation, recover).
 */
