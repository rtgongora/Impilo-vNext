  ...
  return (
    ...
    >
      <div className="space-y-8">
        <Link href="/provider-workspace" className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground">
        ...
        <section>
          ...
          <Link
            ...
            className="mt-3 inline-flex items-center gap-1 text-sm font-medium text-primary-hover hover:underline"
          >
        ...
        <section>
          <h3 className="text-sm font-semibold text-foreground">Management workspaces</h3>
          <p className="mt-1 text-xs text-muted-foreground">Tiles render only when your contract lists the matching management workspace.</p>
