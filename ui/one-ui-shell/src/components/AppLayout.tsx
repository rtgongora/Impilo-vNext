...
export function AppLayout({ children, inlineContext = false }: { children: ReactNode; inlineContext?: boolean }) {
        ...
        <header className="shrink-0 border-b bg-white">
          <div className="flex h-12 items-center justify-between gap-2 px-4 sm:px-6">
            <div className="flex min-w-0 flex-1 items-center gap-2 text-sm text-gray-500">
              ...
              {inlineContext ? <OperationalContextStrip inline /> : null}
              {facility && (
                <Link
                  href="/facility"
          ...
          {inlineContext ? null : <OperationalContextStrip embedded />}
        </header>
