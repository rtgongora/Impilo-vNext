          ...
          >
            <div className="flex items-start justify-between gap-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-medium text-slate-900 group-hover:text-indigo-900">{option.title}</h4>
                  <p className="mt-1 text-sm text-slate-600">{option.description}</p>
                  <p className="mt-2 text-xs font-medium text-emerald-800">{option.outcome}</p>
                </div>
              </div>
