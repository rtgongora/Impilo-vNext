...
export function PublicHealthOutreachOrchestrationPanel() {
  ...
  return (
    <section
      className="mb-4 rounded-2xl border border-emerald-200 bg-emerald-50/80 p-4"
    ...
    >
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-xs text-emerald-800" data-testid="outreach-field-kpi-strip">
            {tasksQ.isLoading
        ...
        <Link
          ...
          className="inline-flex items-center gap-1 rounded-lg border border-emerald-200 bg-white px-2.5 py-1.5 text-xs font-medium text-emerald-900 hover:border-emerald-300"
        >
