...
const NdilaMapLibre = dynamic(() => import("./NdilaMapLibre").then((mod) => mod.NdilaMapLibre), {
  ssr: false,
  loading: () => (
    <div className="flex h-full min-h-[12rem] items-center justify-center text-xs text-gray-500">
...
export function NdilaMap({
  ...
  return (
    <div className="overflow-hidden rounded-lg border border-gray-200 bg-slate-50" data-testid="ndila-map">
      ...
      <div className="relative w-full" style={{ height }} aria-label="Ndila spatial canvas">
        {tileQ.isLoading ? (
          <div className="absolute inset-0 z-10 flex items-center justify-center gap-2 bg-white/70 text-xs text-gray-500">
        ...
        <div className="pointer-events-none absolute bottom-1 right-2 text-[9px] text-gray-500">
