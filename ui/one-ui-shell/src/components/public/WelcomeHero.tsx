...
export function WelcomeHero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto grid max-w-[110rem] gap-0 px-4 py-6 sm:px-6 lg:min-h-[min(44rem,calc(100vh-5rem))] lg:grid-cols-[minmax(0,38fr)_minmax(26rem,62fr)] lg:gap-8 lg:px-8 lg:py-6">
