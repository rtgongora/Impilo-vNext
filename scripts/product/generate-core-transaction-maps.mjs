...
const COMPLETION_EVIDENCE = {
  ...
  "wallet-payment": {
    ...
    tests: [
      "ui/one-ui-shell/src/lib/__tests__/wallet-payment-golden-thread.test.ts",
  ...
  "coverage-enrollment": {
    ...
    tests: [
      "ui/one-ui-shell/src/lib/__tests__/coverage-enrollment-golden-thread.test.ts",
  ...
  "consent-capture": {
    ...
    tests: [
      "ui/one-ui-shell/src/lib/__tests__/consent-capture-golden-thread.test.ts",
  ...
  "telemedicine-encounter": {
    ...
    tests: [
      "ui/one-ui-shell/src/lib/__tests__/telemedicine-encounter-golden-thread.test.ts",
  ...
  "document-upload": {
    ...
    tests: [
      "ui/one-ui-shell/src/lib/__tests__/document-upload-golden-thread.test.ts",
  ...
  "payment-billing-claim": {
    bffEndpoints: [
      ...
      "/internal/v1/finance/billing-workspace",
    ],
    uiRoutes: ["/finance", "/finance/payer-ops", "/finance/billing", "/finance/claims"],
    tests: [
      "ui/one-ui-shell/src/lib/__tests__/payment-billing-claim-golden-thread.test.ts",
