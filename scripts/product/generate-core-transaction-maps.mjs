...
const JOURNEY_GAP_OVERRIDES = {
  ...
  "workspace-context-selection": { missingFrontend: "control-tower dashboards thin" },
  ...
  "telemedicine-encounter": { missingFrontend: "RTC media transport preview-limited (lifecycle BFF wired)" },
  ...
  "consent-capture": { missingFrontend: "remote-session admin depth" },
  ...
  "fundo-learning": { missingFrontend: "mobile learning shell shallow (web catalogue/enrolment complete)" },
...
const JOURNEYS = [
  ...
  },
  {
    ...
    implStatus: "partial",
    missingBackend: "",
    missingFrontend: "control-tower dashboards thin",
