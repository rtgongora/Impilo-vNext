...
apply_seed varapi "$SEED_DIR/14-seed-persona-truth-pack-varapi.sql" "Persona truth pack VARAPI" "SELECT count(*) FROM varapi.provider WHERE provider_public_id='PROV-ZW-00012';"
apply_seed workforce_governance "$SEED_DIR/15-seed-persona-truth-pack-wgv.sql" "Persona truth pack WGV" "SELECT count(*) FROM wgv_assignment WHERE id='f5000000-0000-4000-8000-000000000035'::uuid;"
