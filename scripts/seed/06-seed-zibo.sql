...
--
-- Artifacts and packs are seeded PUBLISHED, not ACTIVE. ACTIVE is a review state in
-- ArtifactStatus, and ArtifactResolutionService serves only PUBLISHED — so seeding ACTIVE
-- produced six vocabularies that were consumed for months while being formally unresolvable.
-- See services/zibo-service/.../db/migration/V402 for the correction to existing estates.
-- =============================================================================
