...
const CAPABILITIES = [
  {
    ...
    maturity: "Partial",
    priority: "HIGH",
    gap: "Chart-access audit only on some surfaces",
    action: "Expand trust context panel on settings + admin",
  },
  {
    plane: "Registry",
    domain: "VITO",
  ...
  },
  {
    ...
    maturity: "Not Wired",
    priority: "HIGH",
    gap: "Placeholder page only",
    action: "BFF bridge + honest Not wired until live",
  },
  {
    plane: "Registry",
    domain: "ZIBO",
  ...
  },
  {
    ...
    maturity: "Partial",
    priority: "HIGH",
    gap: "Detail pages and offline queue UX",
    action: "Guided workflow/dispatch detail",
  },
  {
    plane: "Platform",
