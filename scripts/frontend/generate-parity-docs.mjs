...
const CAPABILITIES = [
  ...
  },
  {
    ...
    maturity: "Live",
    priority: "HIGH",
    gap: "Nompilo donor assist depth",
    action: "Expand Nompilo guided pre-screening",
  },
  {
    plane: "Clinical",
    domain: "MADI",
    ...
    maturity: "Live",
    priority: "HIGH",
    gap: "Offline drive capture conflict UX",
    action: "Harden offline sync for drive field capture",
  },
  {
    plane: "Clinical",
    domain: "MADI",
    ...
    maturity: "Live",
    priority: "MEDIUM",
    gap: "ZIBO terminology deep-link",
    action: "Surface component catalogue codes in UI",
  },
  {
    plane: "Clinical",
    domain: "MADI",
    ...
    maturity: "Live",
    priority: "HIGH",
    gap: "IoT fridge temperature integration",
    action: "Wire cold-chain sensor readiness",
  },
  {
    plane: "Clinical",
    domain: "MADI",
    ...
    maturity: "Live",
    priority: "HIGH",
    gap: "OROS ServiceRequest deep-link from order detail",
    action: "Surface OROS order ref in order tracking UI",
  },
  {
    plane: "Clinical",
    domain: "MADI",
    ...
    maturity: "Live",
    priority: "HIGH",
    gap: "Biometric patient verification",
    action: "Wire Impilo ID verification when available",
  },
  {
    plane: "Clinical",
    domain: "MADI",
    ...
    maturity: "Live",
    priority: "HIGH",
    gap: "National haemovigilance roll-up",
    action: "Public-health supervisory dashboard depth",
  },
  {
    plane: "Clinical",
    domain: "MADI",
    ...
    maturity: "Live",
    priority: "MEDIUM",
    gap: "Emergency redistribution workflow",
    action: "Add emergency allocation actions",
  },
  {
    plane: "Clinical",
    domain: "MADI",
    ...
    maturity: "Live",
    priority: "MEDIUM",
    gap: "30-day demand forecast depth",
    action: "Expand forecasting models",
  },
];
