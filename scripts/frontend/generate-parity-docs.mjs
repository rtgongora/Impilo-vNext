...
const CAPABILITIES = [
  ...
  {
    plane: "Data",
    domain: "Telemedicine analytics",
    capability: "Telemedicine lifecycle SLA aggregates + event ingest",
    backend: "/internal/v1/telemedicine/sla, /internal/v1/telemedicine/events",
    contract: "analytics-pipeline-service (internal)",
    webRoute: "/telemedicine/analytics",
    webClient: "useTelemedicineAnalytics.ts",
    web: "yes",
    mobile: "no",
    nompilo: "no",
    maturity: "Live",
  ...
  {
    plane: "Trust",
    domain: "Break-glass (provider request)",
    capability: "Emergency access override request from clinical/emergency shells",
    backend: "POST /internal/v1/trust/break-glass",
    contract: "tshepo-authz /v1/break-glass",
    webRoute: "/clinical/emergency, /ehr/[patientId]/emergency",
    webClient: "useTrustBreakGlass.ts, BreakGlassRequestPanel.tsx",
    web: "yes",
    mobile: "partial",
    nompilo: "no",
    maturity: "Partial",
    priority: "HIGH",
    gap: "Mobile provider break-glass still uses legacy mobile BFF stubs",
    action: "Provider break-glass panel on ED + EHR emergency views",
  },
  {
    plane: "Enterprise",
  ...
  },
  {
    plane: "Experience",
    domain: "Impilo Live",
    capability: "Live events, webinars, broadcasts",
    backend: "/internal/v1/live/*",
    contract: "contracts/openapi/impilo-live.openapi.yaml",
    webRoute: "/live, /live/discover, /live/event/[eventId]",
    webClient: "useLive.ts",
    web: "yes",
    mobile: "yes",
    nompilo: "yes",
    maturity: "Live",
    priority: "MEDIUM",
    gap: "Host controls on mobile partial",
    action: "Deepen provider host/moderator mobile controls",
  },
  {
    plane: "Experience",
    domain: "Health OS Launcher",
    capability: "Role/facility-aware app launcher + marketplace tiles",
    backend: "/internal/v1/launcher/apps, /internal/v1/launcher/apps/{appCode}/state",
    contract: "contracts/openapi/experience-bff.openapi.yaml",
    webRoute: "ShellStartMenu (Start menu)",
    webClient: "useHealthOsLauncher.ts",
    web: "yes",
    mobile: "partial",
    nompilo: "no",
    maturity: "Partial",
    priority: "HIGH",
    gap: "Mobile launcher parity",
    action: "Shell Start menu uses BFF launcher/apps contract surface",
  },
  {
    plane: "Experience",
    domain: "Wellness / Monitoring",
    capability: "Citizen remote monitoring device pair/list/sync",
    backend: "/internal/v1/mobile/citizen/monitoring/devices",
    contract: "contracts/openapi/experience-bff.openapi.yaml",
    webRoute: "/monitoring/devices",
    webClient: "useCitizenMonitoring.ts, citizen-monitoring-api.ts",
    web: "yes",
    mobile: "yes",
    nompilo: "no",
    maturity: "Partial",
    priority: "MEDIUM",
    gap: "Readings timeline depth",
    action: "BFF explicit proxy to wellness-service; web + citizen mobile wired",
  },
  {
    plane: "Clinical",
    domain: "MADI",
