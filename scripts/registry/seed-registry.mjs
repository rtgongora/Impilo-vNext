...
const LEGACY = new Map(
  [
    ...
    ["rito-quality-safety-service", { id: "rito-quality-safety-service", plane: "experience", sovereign: false, primary_protocol: "rest", default_http_port: 8390, product_names: ["Rito"] }],
  ]
);
