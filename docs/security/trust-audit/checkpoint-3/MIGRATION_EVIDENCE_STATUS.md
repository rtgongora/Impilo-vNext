...
| Retention window | **INSUFFICIENT_EVIDENCE** | Artifacts exist and are permissioned (`drwx------` / `-rw-------`), but no documented calendar retention policy (e.g. N days) was found in committed evidence |
