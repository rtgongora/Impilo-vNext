...
**Runtime four-lane rig:** IN PROGRESS — see §Open. The estate has what it needs to close the money loop live (mushex SANDBOX adapter with `apply-simulation-outcome-on-create`; `bootstrap-topics.sh`).
