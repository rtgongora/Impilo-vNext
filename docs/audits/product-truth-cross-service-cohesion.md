...
|---------|-------------------|--------|-------|
| identity-login-context | tshepo-authz-service, tshepo-identity-service, vito-service, experience-bff | review | Weakest link: mostly-real / real / real / mostly-real |
| provider-workforce-context | varapi-service, vashandi-workforce-service, workforce-governance-service | review | Weakest link: real / real / mostly-real |
...
| maps-geospatial-logistics | ndila-service, nhume-service, dispatch-service | review | Weakest link: real / real / real |
| marketplace-procurement-claims | msika-service, msika-flow-service, procurement-service, mushex-service | review | Weakest link: real / real / mostly-real / mostly-real |
