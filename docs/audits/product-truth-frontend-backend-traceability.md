...
| /work/telemedicine/groups | Clinical Groups | queue | no | no | yes | no | no | — |
| /work/telemedicine/virtual-hospitals | Virtual Hospitals | queue | no | no | yes | no | no | — |
| /work/telemedicine/virtual-hospitals/[id] | Virtual Hospital | queue | no | no | yes | no | yes | — |
