# llm-orchestration-service — Internal Only

> **Classification:** Q — internal-only; no actor-facing UI required.

## Purpose

Llm Orchestration operates as an internal platform/integration component under the **integration** plane (platform-ops).
