# connector-fhir-adapter — Internal Only

> **Classification:** Q — internal-only; no actor-facing UI required.

## Purpose

Connector FHIR operates as an internal platform/integration component under the **integration** plane (interoperability).
