# national-data-repository-service — Internal Only

> **Classification:** Q — internal-only; no actor-facing UI required.

## Purpose

National Data Repository operates as an internal platform/integration component under the **data** plane (intelligence).
