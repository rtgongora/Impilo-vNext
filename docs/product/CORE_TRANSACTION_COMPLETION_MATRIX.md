...
> Journeys: **47** | Transaction-complete: **46**
...
|----------------|------:|
| transaction-complete | 46 |
| backend-ready-but-frontend-incomplete | 1 |

## Coverage

| Metric | Count |
|--------|------:|
| Backend services mapped to journeys | 60 |
| Backend services unmapped | 31 |
| Unmapped user-facing (needs review) | 0 |
| Frontend routes mapped to journeys | 380 |

## Completion matrix

| journey | type | classification | routes | mobile | gap |
| --- | --- | --- | --- | --- | --- |
| Citizen / Client Onboarding | ADMINISTRATIVE_HEALTH | transaction-complete | 4 | 2 | — |
| Provider Login & Role Activation | ADMINISTRATIVE_HEALTH | transaction-complete | 6 | 2 | — |
| Workspace / Shift Context Selection | ADMINISTRATIVE_HEALTH | transaction-complete | 8 | 0 | — |
| Facility Context Selection | ADMINISTRATIVE_HEALTH | transaction-complete | 2 | 57 | — |
...
| Provider Patient Encounter | FACILITY_WALK_IN | transaction-complete | 3 | 1 | — |
...
| Telemedicine Encounter | TELEMEDICINE | transaction-complete | 4 | 3 | — |
...
| Consent Capture | ADMINISTRATIVE_HEALTH | transaction-complete | 10 | 1 | — |
| Payment / Billing / Exemption / Claim | ADMINISTRATIVE_HEALTH | transaction-complete | 28 | 4 | — |
| Document Upload / Scan / Index | ADMINISTRATIVE_HEALTH | transaction-complete | 1 | 1 | — |
| Dispatch / Delivery (NHUME) | MARKETPLACE | transaction-complete | 18 | 2 | — |
| Notification & Communications | ADMINISTRATIVE_HEALTH | transaction-complete | 3 | 3 | — |
| Fundo / Learning Journey | TRAINING_OR_COMPETENCY | transaction-complete | 54 | 2 | — |
| Data / Report / Dashboard Journey | ADMINISTRATIVE_HEALTH | transaction-complete | 18 | 3 | — |
| Registry Administration | ADMINISTRATIVE_HEALTH | transaction-complete | 34 | 1 | — |
| Integration / Sync / Replay | ADMINISTRATIVE_HEALTH | transaction-complete | 6 | 0 | — |
| Device / System Event Journey | ADMINISTRATIVE_HEALTH | transaction-complete | 48 | 0 | ops admin surface only (by design) |
| Health ID Issuance & Card Ops | ADMINISTRATIVE_HEALTH | transaction-complete | 16 | 1 | — |
| Marketplace Order | MARKETPLACE | transaction-complete | 12 | 7 | — |
| Wellness & Lifestyle Journey | WELLNESS | transaction-complete | 13 | 1 | — |
| Impilo Live Events | WELLNESS | backend-ready-but-frontend-incomplete | 13 | 6 | — |
| Social / Community / Timeline | WELLNESS | transaction-complete | 6 | 11 | — |
| Public Health / CHW Outreach | COMMUNITY_OUTREACH | transaction-complete | 5 | 6 | — |
| Civil Registration (UBOMI / CRVS) | ADMINISTRATIVE_HEALTH | transaction-complete | 20 | 1 | — |
...
| Offline Clinical Queue | FACILITY_WALK_IN | transaction-complete | 25 | 4 | — |
...
| Provider Registry Onboarding | ADMINISTRATIVE_HEALTH | transaction-complete | 19 | 4 | — |
...
1. **Provider Patient Encounter** — transaction-complete: 
1. **Core Transaction Orchestration Shell** — transaction-complete: 
1. **Health ID Issuance & Card Ops** — transaction-complete: 
1. **Payment / Billing / Exemption / Claim** — transaction-complete: 
1. **Lab Order & Result** — transaction-complete: 
1. **Public Health / CHW Outreach** — transaction-complete: 
1. **Civil Registration (UBOMI / CRVS)** — transaction-complete: 
