...
| Impilo Live | Live events / CPD / education | Person, Provider | Experience | live-service | `services/live-service` | `contracts/openapi/impilo-live.openapi.yaml`, `contracts/impilo-live.ts` | `/internal/v1/live/*` (typed: clinical-sessions, fundo-webinars, public-broadcasts) | `/live/*` (14 routes incl. /live/admin) | LiveDiscoverScreen, LiveEventScreen | ProviderLiveHubScreen | live-service, rtc-gateway-service | experience compose | live-service tests, useLive | **Live** | Media via rtc-gateway; PCT/Fundo/Campaigns integration bridges |
