...
| **8397** | `mental-health-service` | **RESERVED** — Integrated Emergency pack (product-owner ruling 2026-07-26: build a real service, not a typed refusal). The accepting counterparty for a psychiatric emergency handover: `mh_referral`, `mh_assessment`, `mh_risk_formulation`, `mh_safety_plan`, `mh_involuntary_episode` (statutory detention with a legal-basis field), `mh_restraint_event` (restraint-*reduction* register), `mh_admission_request` (raises to PCT, never decides), `mh_followup`. Care Continuum **component**, `continuum_parent: pct-service`; must not own the admission decision, person-level longitudinal registries, or a second care continuum. Claimed in [iatg-emergency-leases](../registry/iatg-emergency-leases.md) §4 — originally planned as 8395, moved after the surgery lane took 8395/8396 mid-flight. 8398 remains free; 8399 is `referral-service`. |
