...
**Amends:** frozen architecture v1.3.8 (ADR-0054) → **v1.3.11**
**Implementation note:** v1.3.9 was the first attempt to carry these decisions and was refused freeze — it left `controller_type` NOT NULL against decision 1, and guarded none of decisions 1, 3, 5 and 6. v1.3.10 completed the content and v1.3.11 completed their enforcement. This ADR's decisions are unchanged; only their implementation was incomplete.
