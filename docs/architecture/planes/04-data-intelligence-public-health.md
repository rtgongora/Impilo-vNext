...
| `campaigns-service` | `campaigns-service` | intelligence | Campaigns canonical records | must-not-handle-care-transaction-orchestration, must-not-bypass-consent-governance |
...
| `surveillance-service` | `surveillance-service` | intelligence | Surveillance canonical records | must-not-handle-care-transaction-orchestration, must-not-bypass-consent-governance |
