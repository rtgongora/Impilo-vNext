...
1. [`hybrid-federated-target-architecture-v1.3.5.md`](./hybrid-federated-target-architecture-v1.3.5.md)
   ...
   This version carries the correction history of v1.3.2 through v1.3.5 and
   remains not architecture-frozen until Product Owner sign-off. v1.3.1,
   v1.3.2, v1.3.3 and v1.3.4 are archived working drafts; not one of them
   was ever frozen.
