...
1. [`hybrid-federated-target-architecture-v1.3.2.md`](./hybrid-federated-target-architecture-v1.3.2.md)
   ...
   This version contains the v1.3.2 integrity correction and remains
   not architecture-frozen until Product Owner sign-off.
