...
1. [`hybrid-federated-target-architecture-v1.3.7.md`](./hybrid-federated-target-architecture-v1.3.7.md)
   ...
   This version carries the correction history of v1.3.2 through v1.3.7 and
