...
1. [`hybrid-federated-target-architecture-v1.3.10.md`](./hybrid-federated-target-architecture-v1.3.10.md)
   ...
   This version carries the correction history of v1.3.2 through v1.3.10 and
