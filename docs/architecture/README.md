...
1. [`hybrid-federated-target-architecture-v1.3.3.md`](./hybrid-federated-target-architecture-v1.3.3.md)
   ...
   This version carries the v1.3.2 integrity correction and the v1.3.3
   freeze-review correction, and remains not architecture-frozen until
   Product Owner sign-off. v1.3.1 and v1.3.2 are archived working drafts.
