...
| Wellness Authority | wellness-service | simba-service | Wellness capability ownership and API namespace overlap | Simba is canonical owner | Alias marked non-authoritative; BFF default target canonicalized to Simba | Retire alias runtime by approved sunset milestones | Medium | No |
