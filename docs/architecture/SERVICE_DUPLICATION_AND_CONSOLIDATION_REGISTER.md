...
| Dispatch and Last-Mile Lifecycle | dispatch-service | nhume-service | Delivery orchestration boundary overlap risk (routing/tracking/assignment) | Nhume is canonical dispatch and last-mile lifecycle owner; dispatch should consume Nhume/Ndila capabilities where needed | Registered Nhume and Ndila as explicit integration services with canonical SoR boundaries in registry maps | Complete dispatch-to-Nhume boundary migration plan and keep duplicate logistics state out of dispatch-service | Medium | No |
