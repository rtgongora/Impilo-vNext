...
|---|---|---|---|---|---|---|---|
| abis-service | trust | no | none | optional | not_deployable | no chart | add subchart or impilo-vnext template |
...
| organization-registry-service | registry | no | none | optional | not_deployable | no chart | add subchart or impilo-vnext template |
