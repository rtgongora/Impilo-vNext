...
| ehr | ui/ehr | experience | frontend_app | MISSING Dockerfile (legacy) | buildpacks | no | UI workspace not independently deployed — not a missing Dockerfile failure | No Dockerfile unless independent deploy required |
...
| mushex-finance-console | ui/mushex-finance-console | experience | frontend_app | MISSING Dockerfile (legacy) | buildpacks | no | UI workspace not independently deployed — not a missing Dockerfile failure | No Dockerfile unless independent deploy required |
| mushex-ops-console | ui/mushex-ops-console | experience | frontend_app | MISSING Dockerfile (legacy) | buildpacks | no | UI workspace not independently deployed — not a missing Dockerfile failure | No Dockerfile unless independent deploy required |
| mushex-payer-portal | ui/mushex-payer-portal | experience | frontend_app | MISSING Dockerfile (legacy) | buildpacks | no | UI workspace not independently deployed — not a missing Dockerfile failure | No Dockerfile unless independent deploy required |
...
**Count:** 23 UI/buildpack workspaces reclassified as non-blocking.
