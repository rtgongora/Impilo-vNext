# MLCSCZ — Medical Laboratory & Clinical Scientists Council of Zimbabwe
...
| Professions (indicative) | Medical laboratory scientists, medical laboratory technicians, clinical scientists (`TO_CONFIRM` full schedule incl. cytology/histology/blood-transfusion streams) |
| Jurisdiction | NATIONAL |

## Registers (varapi V029/V030 seeds — `TO_CONFIRM` exact statutory names)
- `MLCSCZ_LAB_SCIENTIST` — Register of Medical Laboratory Scientists
- `MLCSCZ_LAB_TECHNICIAN` — Register of Medical Laboratory Technicians
- `MLCSCZ_CLINICAL_SCIENTIST` — Register of Clinical Scientists
- `MLCSCZ_PROVISIONAL` — Provisional register (`TO_CONFIRM`)
...
```json
{
  ...
  "fee_schedule_ref": "MLCSCZ_FEES_PENDING",
  "document_requirements": ["qualification", "identity", "TO_CONFIRM"],
  "registers": ["MLCSCZ_LAB_SCIENTIST", "MLCSCZ_LAB_TECHNICIAN", "MLCSCZ_CLINICAL_SCIENTIST"]
}
```
